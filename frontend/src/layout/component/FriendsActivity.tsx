                        ...
                        >
                            <div className="flex items-start gap-3">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0.5 right-0 h-3 w-3 rounded-full border-2 border-zinc-900
                                            bg-zinc-500"
                                            aria-hidden='true'/>
                                </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {isPLaying ? (
                                        <div className="mt-1">
                                            <div  className="mt-1 text-xs text-white font-medium truncate">Cardigan</div>
