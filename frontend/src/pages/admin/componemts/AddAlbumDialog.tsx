...
const AddAlbumDialog = () => {
    ...
    const [albumDialogOpen , setOpenDialogOpen ] = useState(false);
    ...
    const handleSubmit = async () => {
        ...
        try{
            ...
            await axiosInsttance.post("/admin/albums", formData,{
                headers: {
    ...
    return(
        <Dialog open={albumDialogOpen} onOpenChange={setOpenDialogOpen}>
            ...
            <DialogContent className="bg-zinc-900 border-zinc-700 max-h-[80vh] overflow-auto">
                ...
                <div className="space-y-4 p-y-4">
                    ...
                    />
                    {/* image Upload area */}
                    <div className="flex items-center justify-center p-6 border-2 border-dashed border-zinc-700
                ...
                <DialogFooter>
                    <Button variant="outline" onClick={() => setOpenDialogOpen(false)} disabled={isLoading}>
                        Cancel
                    </Button>
